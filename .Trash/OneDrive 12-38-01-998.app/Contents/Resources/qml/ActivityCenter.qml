...
Rectangle
{
    ...
    property bool hasOldErrorBanner: (needsAttention && headerModel.shouldShowErrorBanner && !errorsModel.isErrorsV2)
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Image {
                        ...
                        source: isAddedFolderItem ? ("file:///" + imageLocation + ((Qt.platform.os === "osx") ? "addedFolderIcon_mac.svg" : "addedFolderIcon_win.svg")) :
                                                    ("image://fileIcons/" + itemName)
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    ...
                                    width: {
                                        var spaceAvailable = itemStatusRect.width - itemDescriptionSuffixText.width;
                                        // add 1 to the calculated width because of truncation on Mac
                                        var stringWidth = headerModel.getPixelWidthOfString("Segoe UI", 12, itemActionPrefix) + 1;
                                        return Math.min(spaceAvailable, stringWidth);
                                    }
                                    elide: Text.ElideRight
